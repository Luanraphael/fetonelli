...
PAGES = [
    {
        ...
        "topbar": 'Precio promocional válido solo el día <strong class="topbar-hl">22/09</strong>',
    ...
    },
    {
        ...
        "topbar": 'Valor promocional válido apenas no dia <strong class="topbar-hl">22/09</strong>',
